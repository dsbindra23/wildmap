  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <h1 className="text-xl font-semibold mb-6 text-center" style={{ color: "var(--fg)" }}>Sign in</h1>
        ...
        <div className="rounded-xl border p-6 space-y-4" style={{ borderColor: "var(--border)", backgroundColor: "var(--bg)" }}>
          ...
          <p className="text-xs text-center" style={{ color: "var(--fg-3)" }}>
            No account?{" "}
            <Link href="/auth/register" className="underline underline-offset-2" style={{ color: "var(--fg-2)" }}>
              Sign up free
            </Link>
          </p>
        </div>
